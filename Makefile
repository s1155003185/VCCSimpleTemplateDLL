...
RELEASE_FLAGS :=
CXXFLAGS_DEBUG := -fdiagnostics-color=always -std=c++17 -Wall -Wextra -pthread -fPIC -shared $(DEBUG_FLAGS) -g
CXXFLAGS_RELEASE := -fdiagnostics-color=always -std=c++17 -pthread -O3 -fPIC -shared $(RELEASE_FLAGS)
